...
Si en algún momento querés validar eso, lo vemos."`
        ...
        rebuttals: [
            ...
            { t: "Boca a boca: 'Sólo vivimos de indicação'", q: "boca boca recomendacion indicacao", a: "Pô, o trabalho de vocês debe ser muito bom mesmo entonces. Pero fijate esto: la persona que recibe esa recomendación va a ir a buscarte a Google para confirmar, y si ve un sitio que da mala impresión o no encuentra nada, desiste y es plata que dejás en la mesa. Dejame mostrarte en 5 minutos cómo agarrar a esos clientes." },
            { t: "Estafado 2: 'Me quisieron cobrar carisimo'", q: "caro estafado plata reales 3000", a: "Te entiendo, 3 mil reales es mucha plata. Y si te dijera que yo ya hice el sitio de [Marca], y si llega a gustarte, el costo es una fracción mínima de eso? No cuesta nada mirar la pantalla, si no te gusta, simplemente te vas." },
...
Se em algum momento quiser validar isso, a gente vê."`
        ...
        rebuttals: [
            ...
            { t: "Estafado 2: 'Me cobraram caríssimo'", q: "caro estafado dinheiro reais 3000", a: "Eu te entendo, 3 mil reais é muito dinheiro. E se eu te dissesse que já fiz o site da [Marca] e, se você gostar, o custo é uma fração mínima disso? Não custa nada olhar a tela, se não gostar, você simplesmente vai embora." },
